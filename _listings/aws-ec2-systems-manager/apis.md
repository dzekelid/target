...
- name: AWS EC2 Systems Manager API - Register Target With Maintenance Window
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/target/master/_listings/aws-ec2-systems-manager/actionregistertargetwithmaintenancewindow-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/target/master/_listings/aws-ec2-systems-manager/actionregistertargetwithmaintenancewindow-get-openapi.md
x-common:
- type: x-api-gallery
